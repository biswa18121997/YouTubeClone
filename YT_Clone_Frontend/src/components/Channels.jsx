...
function Channels() {
  ...
  return (<div className="w-[80vw] relative left-[18vw] h-fit m-2 p-2 ">
    <div className="flex p-2 m-2 border rounded-4xl w-fit justify-center items-center">
    ...
    <div className="w-full relative h-[50vh] border overflow-y-scroll">
        <h1>Your Current Channels :</h1>
      {channelData.message && <h2>No Channels You Have </h2>}  
