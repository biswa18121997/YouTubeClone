...
function Profile() {
  ...
  return (
    <div className="w-[80vw] relative left-[18vw] h-fit m-2 p-2 top-[12vh]">
        <div className='flex bg-center bg-[url("https://i.pinimg.com/736x/a1/6a/5d/a16a5d9a952874e51fe0d56951c5d19f.jpg")]'>
            ...
            <div className="flex flex-col p-2 m-4 text-yellow-400  w-full justify-center bg-linear-to-r/increasing from-indigo-500/50 to-teal-400/50">
        ...
        <h1>DOWNLOADS</h1>
        <div>
          {profileData?.profileData?.downloaded?.map((items)=><VideoPreviewCard item={items}/>)}
